...
- **VMC:** ASCII `STATget` / `STATset` (and other categories if you build them) via [`LegacyVmcContainer`](../../src/MonitorControlSDK/Internal/LegacyVmcContainer.cs) and [`VmcClient`](../../src/MonitorControlSDK/Clients/VmcClient.cs). Item number is **`0xB000`** by default or **`0xB001`** for the built-in-controller path (programmer manual): set [`VmcClient.VmcItemNumber`](../../src/MonitorControlSDK/Clients/VmcClient.cs), call [`SdcpMessageBuffer.setupVmcPacketHeader(ushort)`](../../src/MonitorControlSDK/Protocol/SdcpMessageBuffer.cs), or parse REST/CLI strings with [`SdcpMessageBuffer.ParseVmcItemSpecifier`](../../src/MonitorControlSDK/Protocol/SdcpMessageBuffer.cs). UDP broadcast uses [`VmcUdpBroadcastClient.VmcItemNumber`](../../src/MonitorControlSDK/Clients/VmcUdpBroadcastClient.cs).

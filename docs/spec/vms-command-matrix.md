# VMS command matrix (short)

Architecture and exhaustive listings: [**reference/vms-overview.md**](../reference/vms-overview.md).

References ↔ SDK parity (where historical monitor-app / updater wrappers fit): [**reference/references-parity.md**](../reference/references-parity.md).
